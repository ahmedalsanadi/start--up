<x-layout title="Home">
    <div class="space-y-8">
        <!-- Hero Section -->
        <div class="relative bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-700 dark:to-indigo-800 rounded-2xl p-8 mb-8 overflow-hidden">
            ...
            <div class="absolute -top-10 -right-10 w-24 h-24 bg-indigo-400/20 rounded-full blur-2xl animate-float delay-1000">
            </div>
        </div>
                ...
                <div class="flex flex-wrap gap-3">
                    @foreach($categories as $parentCategory)
                        <div class="category-group relative">
                            ...
                            <div class="category-children hidden absolute z-20 mt-2 w-56 rounded-xl shadow-xl bg-white dark:bg-gray-700 p-2">
                                @foreach($parentCategory->children as $child)
                                    <label class="flex items-center px-4 py-3 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600">
        ...
        <div class="space-y-6">
            @forelse($announcements as $announcement)
                <div class="relative">
                    ...
                    <!-- Card Content -->
                    <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 relative overflow-hidden" dir="rtl">
                            ...
                            <div class="w-full p-6 md:p-8">
                                <div class="flex items-center justify-between mb-6">
                                    <div class="flex items-center space-x-4 space-x-reverse">
                                        <x-profile-img :src="$announcement->investor->profile_image" :alt="$announcement->investor->name" size="md" />
                                        <div>
                                    ...
                                    <button class="px-4 py-2 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                                        إضافة فكرة
                                ...
                                <div class="space-y-8">
                                    <p class="text-gray-600 dark:text-gray-300">{{ $announcement->description }}</p>

                                    <div class="flex items-center gap-6 mt-4">
                                        <div class="flex items-center gap-3">
                                            <!-- Icon Container -->
                                            <div class="p-2 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                                                <i data-lucide="map-pin" class="w-8 h-8 text-green-500 dark:text-green-300"></i>
                                            </div>

                                            <!-- Label and Value -->
                                            <div class="flex flex-col justify-center gap-1">
                                                <span class="text-sm font-semibold text-gray-900 dark:text-white">الموقع</span>
                                                <p class="text-gray-600 dark:text-gray-400">{{ $announcement->location }}</p>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-3">
                                            <!-- Icon Container -->
                                            <div class="p-2 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                                                <i data-lucide="dollar-sign" class="w-8 h-8 text-green-500 dark:text-green-300"></i>
                                            </div>

                                            <!-- Label and Value -->
                                            <div class="flex flex-col justify-center gap-1">
                                                <span class="text-sm font-semibold text-gray-900 dark:text-white">الميزانية</span>
                                                <p class="text-gray-600 dark:text-gray-400">{{ number_format($announcement->budget, 0) . ' ريال' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                                    <div class="flex flex-wrap gap-2">
                                        @foreach($announcement->categories as $category)
                                            <span class="px-4 py-1.5 text-sm font-medium rounded-full bg-blue-50 text-blue-600 dark:bg-blue-900/30 dark:text-blue-300">
                                                {{ $category->name }}
                                            </span>
                                        @endforeach
                                    </div>
    ...
    @push('scripts')
        <script>
            // JavaScript for filtering and managing categories (same as in the original code)
        </script>
    @endpush
</x-layout>
