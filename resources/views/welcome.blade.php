    ...
    <div class="bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        ...
        <section class="relative min-h-screen geometric-bg overflow-hidden">
            ...
            <div class="absolute inset-0 overflow-hidden pointer-events-none">
                <div
                    class="absolute top-20 left-10 w-72 h-72 bg-blue-400/10 dark:bg-blue-600/10 rounded-full blur-3xl animate-pulse">
                </div>
                <div class="absolute bottom-20 right-10 w-96 h-96 bg-blue-500/10 dark:bg-blue-700/10 rounded-full blur-3xl animate-pulse"
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="text-right order-2 lg:order-1">
                            <div class="fade-in" style="animation-delay: 0.2s">
                                <h1
                                    class="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
                                    حوّل <span class="text-blue-600">أفكارك</span> إلى
                                    <br />مشاريع <span class="text-blue-600">ناجحة</span>
                                </h1>
                                <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                                    منصة ستارت بوكس تجمع بين رواد الأعمال والمستثمرين في مكان واحد. نساعدك في تحويل
                                    أفكارك إلى واقع ملموس من خلال الدعم والتوجيه والتمويل.
                                </p>
                                <div class="flex gap-4 justify-end">
                                    <a href="{{ route('register') }}"
                                        class="inline-flex items-center px-8 py-3 rounded-full bg-blue-600 text-white font-semibold hover:bg-blue-700 transform hover:scale-105 transition-all duration-300">
                                        ابدأ رحلتك
                                        <svg class="w-5 h-5 mr-2 rotate-180" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                    ...
                                    <a href="{{ route('about') }}"
                                        class="inline-flex items-center px-8 py-3 rounded-full bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white font-semibold hover:bg-gray-300 dark:hover:bg-gray-700 transition-all duration-300">
                                        تعرف علينا
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="order-1 lg:order-2 fade-in" style="animation-delay: 0.6s">
                            <div class="relative">
                                <!-- Main Circle -->
                                <div class="absolute inset-0 bg-blue-100 dark:bg-blue-900/20 rounded-full blur-2xl">
                                </div>
                                <div
                                    class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 transform hover:-translate-y-2 transition-all duration-300">
                                    <!-- Animated SVG Illustration -->
                                    <div class="aspect-square">
                                        <svg class="w-full h-full" viewBox="0 0 400 400" fill="none">
                                            <!-- Animated Circles -->
                                            <circle cx="200" cy="200" r="160"
                                                class="stroke-blue-600 dark:stroke-blue-400" stroke-width="2"
                                                stroke-dasharray="1000" stroke-dashoffset="1000">
                                                <animate attributeName="stroke-dashoffset" to="0" dur="2s"
                                                    fill="freeze" />
                                            </circle>
                                            <circle cx="200" cy="200" r="120"
                                                class="stroke-blue-400 dark:stroke-blue-600" stroke-width="2"
                                                stroke-dasharray="800" stroke-dashoffset="800">
                                                <animate attributeName="stroke-dashoffset" to="0" dur="2s" fill="freeze"
                                                    begin="0.5s" />
                                            </circle>
                                            <circle cx="200" cy="200" r="80"
                                                class="stroke-blue-300 dark:stroke-blue-700" stroke-width="2"
                                            ...
                                            <g class="opacity-0" style="animation: fadeIn 0.5s 1.5s forwards">
                                                <!-- Lightbulb -->
                                                <path d="M180 100h40M200 80v40M170 120a40 40 0 1 0 60 0"
                                            ...
                                            <g class="opacity-0" style="animation: fadeIn 0.5s 2s forwards">
                                                <!-- Rocket -->
                                                <path d="M280 200l20-20-20-20-20 20z"
                                                    class="fill-blue-600 dark:fill-blue-400">
                                                    <animateTransform attributeName="transform" type="rotate"
                                                        from="0 280 200" to="360 280 200" dur="4s"
                                            ...
                                            <g class="opacity-0" style="animation: fadeIn 0.5s 2.5s forwards">
                                                <!-- Chart -->
                                                <path d="M100 300v-40l20-20 20 20 20-40 20 40"
                                                    class="stroke-blue-600 dark:stroke-blue-400" stroke-width="2"
                                                    fill="none">
                                                    <animate attributeName="d" dur="3s" repeatCount="indefinite"
                    ...
                    <div class="mt-32">
                        ...
                        <div class="grid md:grid-cols-3 gap-8 fade-in" style="animation-delay: 1s">
                            ...
                            <div
                                ...
                                <div
                                    class="w-14 h-14 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mb-6">
            ...
            <div class="wave-shape">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120"
                    preserveAspectRatio="none" class="fill-blue-600/10 dark:fill-blue-900/20">
                    <path
