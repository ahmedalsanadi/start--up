...
<nav class="fixed top-0 z-50 w-full border-b bg-gray-100 border-gray-200 dark:bg-gray-800 dark:border-gray-700" dir="rtl">
                ...
                <a href="#" class="flex items-center gap-2">
                    ...
                    <div class="relative group">
                        <div class="w-12 h-12 relative">
                            <!-- Gradient Background -->
                            <div class="absolute inset-1 rounded-xl bg-gradient-to-br from-violet-600 via-indigo-500 to-cyan-400 animate-pulse">
                                <div class="absolute inset-0 rounded-xl bg-gradient-to-tr from-pink-500 via-purple-500 to-indigo-500 mix-blend-overlay"></div>
                            </div>
                            <!-- Star Icon -->
                            ...
                            <!-- Glowing Effect -->
                            <div class="absolute -inset-1 rounded-xl bg-gradient-to-br from-violet-600/30 via-indigo-500/30 to-cyan-400/30 blur-lg group-hover:opacity-75 transition duration-300"></div>
                        </div>
                    </div>
                    <!-- Text Logo (Hidden on Small Screens) -->
                    <span class="hidden md:block text-2xl font-extrabold">
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-violet-600 via-indigo-500 to-cyan-400">Start</span>
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">-up</span>
                    </span>
                </a>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative">
                    <button id="notification-bell" type="button"
                        ...
                        <span class="absolute top-0 right-0 inline-flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-red-600 rounded-full">{{ $unreadCount }}</span>
                    </button>
                    <!-- Notification Dropdown Content -->
                    <div class="hidden absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl dark:bg-gray-700" id="dropdown-notifications">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-1">
                                            ...
                                            @if(isset($notification->data['action_url']))
                                                <a href="{{ $notification->data['action_url'] }}" class="text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">View Details</a>
                                            @endif
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-600">
                            <a href="#" class="block py-2 text-sm font-medium text-center text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600">View all notifications</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden sm:flex items-center mx-2">
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                        ...
                        <ul class="py-1" role="none">
                            ...
                            <li>
                                <a href="/manage-account" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Settings</a>
                            </li>
                            <li>
