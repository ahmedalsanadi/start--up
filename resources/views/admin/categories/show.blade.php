<x-layout title="تفاصيل القسم">
    <div class="flex flex-col gap-6 px-2">
        ...
        <div class="relative group">
            ...
            <div
                class="relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div class="flex-grow text-center md:text-right">
                        <div class="flex flex-col gap-2">
                            ...
                            @if($parentCategory)
                                <div
                                    class="flex items-center justify-center md:justify-start gap-2 text-gray-600 dark:text-gray-400">
            ...
            <div
                ...
                <div class="space-y-4">
                    @forelse($children as $child)
                        <div
                            class="group/item flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-150">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-10 h-10 rounded-full bg-indigo-100 dark:bg-indigo-900/50 flex items-center justify-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">تم الإنشاء
                    ...
                    @empty
                        <div class="text-center py-12">
                            <div
                                class="w-20 h-20 bg-gray-100 dark:bg-gray-700/50 rounded-full flex items-center justify-center mx-auto mb-4">
                            ...
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">يمكنك إضافة قسم فرعي جديد من خلال الزر
                                أعلاه</p>
                        </div>
                    @endforelse
                </div>
