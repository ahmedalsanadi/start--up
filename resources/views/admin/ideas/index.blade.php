<x-layout title="إدارة الأفكار">
    <div class="flex flex-col gap-4 px-2">
        ...
        <div class="flex justify-between items-center mb-6">
            <x-page-header>إدارة الأفكار</x-page-header>
            <nav class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                <span>لوحة التحكم</span>
                <i data-lucide="chevron-left" class="w-4 h-4"></i>
                <span class="text-blue-600 dark:text-blue-400">إدارة الأفكار</span>
            </nav>
        </div>

        <!-- Stats Cards -->
        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Card 1: إجمالي الأفكار -->
                        ...
                        <div class="flex items-center justify-between px-4">
                            ...
                            <div class="relative">
                                ...
                                <div
                                    ...
                                    <!-- Lucide Icon -->
                                    <i data-lucide="lightbulb" class="h-6 w-6 text-blue-500 dark:text-blue-300"></i>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="relative group">
                ...
                <div
                    class="relative bg-gray-100 dark:bg-gray-800/95 overflow-hidden rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col gap-1 p-4">
                        <p class="text-gray-950 dark:text-green-200 text-md font-medium truncate">
                            مقبولة
                        </p>
                        <div class="flex items-center justify-between px-4">
                            <div>
            ...
            <div class="relative group">
                ...
                <div
                    class="relative bg-gray-100 dark:bg-gray-800/95 overflow-hidden rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col gap-1 p-4">
                        <p class="text-gray-950 dark:text-yellow-200 text-md font-medium truncate">
                            قيد المراجعة
                        </p>
                        <div class="flex items-center justify-between px-4">
                            <div>
            ...
            <div class="relative group">
                ...
                <div
                    class="relative bg-gray-100 dark:bg-gray-800/95 overflow-hidden rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col gap-1 p-4">
                        <p class="text-gray-950 dark:text-red-200 text-md font-medium truncate">
                            مرفوضة
                        </p>
                        <div class="flex items-center justify-between px-4">
                            <div>
                            ...
                            <div class="relative">
                                ...
                                <div
                                    ...
                                    <!-- Lucide Icon -->
                                    <i data-lucide="x-circle" class="h-6 w-6 text-red-500 dark:text-red-300"></i>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div
            ...
            <!-- Filter Form -->
            <form id="filterForm" action="{{ route('admin.ideas.index') }}" method="GET" class="space-y-4">
                ...
                <div class="flex items-center justify-center gap-4 mt-4">
                    ...
                    <div class="relative w-full">
                        <select name="status"
                            ...
                            <option value="approved" {{ request('status') == 'approved' ? 'selected' : '' }}>مقبولة
                            </option>
                            <option value="rejected" {{ request('status') == 'rejected' ? 'selected' : '' }}>مرفوضة
                            </option>
                            <option value="deleted_by_entrepreneur" {{ request('status') == 'deleted_by_entrepreneur' ? 'selected' : '' }}>محذوفة</option>
                            <option value="expired" {{ request('status') == 'expired' ? 'selected' : '' }}>منتهية الصلاحية
                            </option>
                        </select>
                        <label
                            class="absolute -top-3 right-2 text-xs text-gray-600 bg-white dark:text-gray-400 dark:bg-gray-800 px-2 py-0.5 rounded-full">
        ...
        <form id="exportForm" action="{{ route('export', ['type' => 'idea']) }}" method="POST" class="hidden">
            @csrf
        ...
        <div
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-4 bg-gray-50 dark:bg-gray-800/50">
                <div class="flex justify-between items-center">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">قائمة الأفكار</h3>
                    <span class="text-sm text-gray-500 dark:text-gray-400">
                        عدد النتائج: {{ $ideas->total() }}
                    </span>
                </div>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-800/50">
                        <tr>
                            <th
                                class="px-4 py-2 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">
                                الرائد
                            </th>
                            <th
                                class="px-4 py-2 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">
                                    ...
                                    <div class="border-t border-gray-200 dark:border-gray-700 pt-1">
                                        <div class="flex items-center gap-2">
                                            <i data-lucide="calendar"
                                                class="w-4 h-4 text-blue-600 dark:text-blue-400"></i>
                                            <span class="px-2 py-1 text-pink-600 dark:text-pink-200">تاريخ
                                                الانتهاء</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <th class="px-4 py-2 text-right text-xs font-medium uppercase tracking-wide">
                                <div class="flex flex-col gap-1">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="px-2 py-1 text-pink-600 dark:text-pink-200">حالة الفكرة</span>
                                    </div>
                                    <div class="border-t border-gray-200 dark:border-gray-700 pt-1">
                                        <div class="flex items-center gap-2">
                                            <i data-lucide="check-circle"
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($ideas as $idea)
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-3 whitespace-nowrap">
                                                        <span class="text-xs font-medium text-gray-900 dark:text-white">{{ $idea->name }}</span>
                                                    </td>
                                                    <td class="px-4 py-3 whitespace-nowrap">
                                                        <div class="flex flex-col gap-2">
                                                            <div class="flex items-center gap-2">
                                                                <i data-lucide="map-pin" class="w-4 h-4 text-blue-600 dark:text-blue-400"></i>
                                                                <span
                                                                    class="text-xs text-pink-600 dark:text-pink-200">{{ $idea->location }}</span>
                                                            </div>
                                                            <div class="border-t border-gray-200 dark:border-gray-700 pt-1">
                                                                <div class="flex items-center gap-2">
                                                                    <i data-lucide="dollar-sign"
                                                                    ...
                                                                    <span class="text-xs text-pink-600 dark:text-pink-200">
                                                                        {{ number_format($idea->budget, 2) }} ريال
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="border-t border-gray-200 dark:border-gray-700 pt-1">
                                                                <div class="flex items-center gap-2">
                                                                    ...
                                                                    <span class="text-xs text-gray-400 dark:text-gray-300">
                                                                        {{ $idea->expiry_date ? $idea->expiry_date->format('M d, Y') : 'N/A' }}
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="group border-t border-gray-200 dark:border-gray-700 pt-1">
                                                                <div class="flex items-center gap-4">
                                                                    <i data-lucide="check-circle"
                                                                        class="w-4 h-4 text-blue-600 dark:text-blue-400"></i>
                                                                    @php
                                                                        $approvalStatus = $idea->approval_status;
                                                                        $approvalColors = [
                                                                            'pending' => 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300',
                                                                            'approved' => 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300',
                                                                            'rejected' => 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300',
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-left text-xs font-normal">
                                                        <div class="flex items-center justify-center gap-3">
                                                            @if($idea->approval_status === 'pending')
                                                                ...
                                                                <!-- Reject Button -->
                                                                <button type="button" onclick="openRejectModal('{{ $idea->id }}')"
