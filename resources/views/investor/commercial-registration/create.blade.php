            ...
            <form method="POST" action="{{ route('commercial-registration.store') }}" class="form-container">
                ...
                <div class="space-y-6">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">يرجى تقديم معلومات السجل التجاري الخاص
                            بك للمتابعة</p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="registration_number" name="registration_number"
                            value="{{ old('registration_number') }}" class="form-input"
                            placeholder="أدخل رقم السجل التجاري الخاص بك" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="registration_number_confirmation" name="registration_number_confirmation"
                            class="form-input" placeholder="أكد رقم السجل التجاري الخاص بك" required>
